...
$$\theta_i (s) = \rho_1/ I_{i}*\tau_{EDC} (s) +\rho_2/ I_{i}*\tau_{FDP} (s) + \rho_3/ I_{i}*\tau_{FDS} (s) -\theta_{i} (0) * (s+B_i/I_i)/(s^2+B_i s/I_i+K_i/I_i)+K_i * \theta_{i,eq}/(I_i*(s^2+B_i s/I_i+K_i/I_i)$$
